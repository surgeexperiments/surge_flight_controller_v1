								...
								escOutput_st *esc_output)
{
	if(mode == MOTORS_FLY_MODE ) {
		...
		if (esc_output->one < ESC_RUNNING_MIN_PULSE) esc_output->one = ESC_RUNNING_MIN_PULSE; 
		else if(esc_output->one > ESC_RUNNING_MAX_PULSE)esc_output->one = ESC_RUNNING_MAX_PULSE;  
		
		if (esc_output->two < ESC_RUNNING_MIN_PULSE) esc_output->two = ESC_RUNNING_MIN_PULSE;  
		else if(esc_output->two > ESC_RUNNING_MAX_PULSE)esc_output->two= ESC_RUNNING_MAX_PULSE;
		
		if (esc_output->three < ESC_RUNNING_MIN_PULSE) esc_output->three = ESC_RUNNING_MIN_PULSE;                        
		else if(esc_output->three > ESC_RUNNING_MAX_PULSE)esc_output->three = ESC_RUNNING_MAX_PULSE;                
		                                    
		if (esc_output->four < ESC_RUNNING_MIN_PULSE) esc_output->four = ESC_RUNNING_MIN_PULSE;                                      
		else if(esc_output->four > ESC_RUNNING_MAX_PULSE)esc_output->four = ESC_RUNNING_MAX_PULSE;                                           
	}
