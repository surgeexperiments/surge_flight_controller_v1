 ...
 *
 *	@brief  This file contains prototypes for the SPI functions, function prototypes
 *			and defines used with SPI.
 */
...
void spi_init_lgd20_devboard(SPI_TypeDef *SPIx, uint8_t spiMode);
